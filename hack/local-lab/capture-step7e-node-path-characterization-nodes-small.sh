...
label="${K9S_NEO_BENCH_LABEL:-step7e-node-path-characterization-nodes-small-v1}"
note_path="${K9S_NEO_NODE_PATH_CHARACTERIZATION_NOTE_PATH:-${script_dir}/../../docs/development/step-7e-node-path-characterization-note.md}"
